        ...
        if (!data) {
          ...
          setStudentInfo({
            name:
              ...
              "",
            rollNumber:
              data.roll_number || student.id_id || userData.roll_no || "",
            programme:
              data.programme ||
              student.programme ||
              userData.programme ||
              "B.Tech",
            branch:
              data.branch || student.branch || userData.department || "N/A",
            academicYear:
              data.academic_year ||
              ...
              <Stack spacing={isMobile ? 4 : 8}>
                ...
                >
                  ...
                  {(() => {
                    ...
                    if (
                      semester.type &&
                      semester.type.toLowerCase().includes("summer")
                    ) {
                      const summerMapping = {
                        2: "Summer 1",
                        4: "Summer 2",
                      ...
                      return (
                        summerMapping[semester.no] || `Summer ${semester.no}`
                      );
                    } else {
...
StudentTranscript.propTypes = {
  student: PropTypes.shape({
    id_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
