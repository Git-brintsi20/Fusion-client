      ...
      try {
        ...
        if (err.code === "ECONNABORTED") {
          ...
          if (status === 400) {
            ...
            errorMessage =
              serverMessage ||
              "Account access restricted. Please contact administration.";
          } else if (status === 404) {
            errorMessage =
          ...
          {isLogin && (
            <Box
              style={{
                ...
                boxShadow:
                  "0 0 20px rgba(21, 171, 255, 0.5), 0 0 40px rgba(21, 171, 255, 0.3)",
                borderRadius: "2px",
                ...
                <UnstyledButton
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 15px 50px rgba(21,171,255,0.5)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "translateY(0)";
                    e.currentTarget.style.boxShadow =
                      "0 10px 40px rgba(21,171,255,0.3)";
                  }}
                >
                    ...
                    <Box style={{ position: "relative" }}>
                      ...
                      <Box
                        style={{
                          ...
                          height: 3,
                          background:
                            "linear-gradient(90deg, #15ABFF 0%, transparent 100%)",
                          animation:
                            "slideIn 0.5s ease-out, glow 2s ease-in-out infinite",
                        }}
                      />
                    </Box>
                    <form
                    ...
                    >
                      <Stack gap={isMobile ? "lg" : "xl"}>
                        <Box style={{ position: "relative" }}>
                          <TextInput
                            label={
                              <Text size="xs" fw={800} c="gray.6" mb={5}>
                                USERNAME
                              </Text>
                            }
                            ...
                            onMouseEnter={(e) => {
                              if (!loading && isFormValid) {
                                e.currentTarget.style.transform =
                                  "translateY(-2px)";
                                e.currentTarget.style.boxShadow =
                                  "0 15px 40px rgba(21,171,255,0.5)";
                              }
                            }}
                            onMouseLeave={(e) => {
                              if (!loading && isFormValid) {
